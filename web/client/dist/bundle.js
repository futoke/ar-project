...
var _futoke$ar_project$Main$homePage = A2(
	_elm_lang$html$Html$h1,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _futoke$ar_project$Main$pageBody = function (model) {
	...
	do {
		if (_p2.ctor === '[]') {
			return _futoke$ar_project$Main$homePage;
		} else {
			if (_p2._1.ctor === '[]') {
				switch (_p2._0) {
					case 'home':
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _futoke$ar_project$Main$menuStyle,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _futoke$ar_project$Main$menuElementStyle,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_futoke$ar_project$Main$link, 'home', '#/home'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_futoke$ar_project$Main$link, 'about', '#/about'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_futoke$ar_project$Main$link, 'users', '#/users'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
if (typeof _futoke$ar_project$Main$main !== 'undefined') {
    _futoke$ar_project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"UrlChange":["Navigation.Location"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
